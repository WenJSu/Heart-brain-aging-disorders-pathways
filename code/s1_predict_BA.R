...
# Define paths
cova_data_path <- "E:/UKB/physical/cova_data_more_withPC_all2visits.csv"
cova_data <- read.csv(cova_data_path)
eid_data_path <- "E:/UKB/health_eid/BA_health_eid.csv"
allSiteInfo <- read.table('E:/UKB/physical/AllSiteInfo.csv', sep=',' ,header=T, check.names=F)
HeightInfo <- read.table("E:/UKB/physical/AllHeightInfo.csv", sep=',', header=T, check.names=F)
HeightInfo <- HeightInfo[,c('eid','50-0.0')]
colnames(HeightInfo) <- c('eid', 'Height')
# Define organs and their respective data files
organs <- c('Brain_WM')
sink('G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/imagingvisit_ageModeling_log.txt')
...
for (i in 1:length(organs)) {
  ...
  # Load data
  df_GM <- read.csv("G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/Brain_GM_clean.csv")
  df_WM <- read.csv("G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/Brain_WM_clean.csv")
  ...
  df_HC <- data.frame(df)
  write_csv(df_HC, 'G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/brain_age_prediction.csv')
  save.image(file = "G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/brain_AgeModeling_environment.RData")
  ...
  write.table(corrdata, 'G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/brain_age_prediction_evaluation.csv', sep=',', row.names=F)
  ...
  write_csv(brain_traits, 'G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/Age_LASSO_weights.csv')
  ...
  write_csv(data.frame(df_all), 'G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/brain_age_prediction_all.csv')
}
sink()

selected_df_agegap <-  df_all[, c("eid", "Age", "pre_age", "pre_age_corrected", "delta_corrected")]
write_csv(data.frame(selected_df_agegap), 'G:/SU_otherwork/20241103周在人/1122_brainage_heartIDPs/preidict_brain_age/result/agegap.csv')
